			...
			<div id="content-header">
				...
				<table class="table table-bordered table-striped">
							...
							<th>value</th> 
									...
									<tbody>
							<c:forEach var="step2" items="${step2list}"> 
					            <tr>
					         
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step2.step2Key}"/>  </td>   
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step2.step2Value}"/>  </td>          
