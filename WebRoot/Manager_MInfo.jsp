...
<html lang="en">
	...
	<form method="post" action="manager/uploadM"
			...
			<table class="table table-bordered table-striped">
				...
				<table class="table table-bordered table-striped">
							...
							<th>电影名</th>
									...
									<tbody>
							<c:forEach var="movie" items="${minfolist}"> 
					            <tr>
					         
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${movie.mid}"/>  </td>   
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${movie.mname}"/>  </td>          
