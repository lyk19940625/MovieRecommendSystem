			...
			<div id="content-header">
				...
				<table class="table table-bordered table-striped">
							...
							<th>value</th> 
									...
									<tbody>
							<c:forEach var="step1" items="${step1list}"> 
					            <tr>
					         
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step1.step1Key}"/>  </td>   
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step1.step1Value}"/>  </td>          
