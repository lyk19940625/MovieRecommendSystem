			...
			<div id="content-header">
				...
				<table class="table table-bordered table-striped">
							...
							<th>value</th> 
									...
									<tbody>
							<c:forEach var="step4" items="${step4list}"> 
					            <tr>
					         
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step4.step4Key}"/>  </td>   
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step4.step4Value}"/>  </td>          
