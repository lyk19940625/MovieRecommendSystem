		...
		<div id="content">
			<div id="content-header">
				...
				<table class="table table-bordered table-striped">
					       ...
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step.step1Key}"/>  </td>   
					       <td style="vertical-align:middle; text-align:center;"><c:out value="${step.step1Value}"/>  </td>          
